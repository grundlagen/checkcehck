...
def autofix_code(code, error_msg, radical_mode=False):
    ...
    system_prompt = f"""
You are CodeMedic v2.3, a fault-tolerant Python repair agent. You're repairing `xtts_match_embed.py` which extracts phonetic embeddings using Coqui XTTS v2.
...
4. For model loading issues, insert:
