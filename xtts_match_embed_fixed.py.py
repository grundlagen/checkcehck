...
# Configuration
MAX_ATTEMPTS = 15
BASE_FILE_PATH = r"C:\Users\Lenovo\.spyder-py3\xtts_match_embed.py"  # Changed to raw string
DEEPSEEK_API_KEY = ""
DEEPSEEK_API_URL = "https://api.deepseek.com/v1/chat/completions"
DEBUG_LOG = "autofix_debug.log"
CUMULATIVE_KNOWLEDGE_FILE = "autofix_cumulative_knowledge.txt"

# [Rest of your original code EXACTLY as in the backup...]
# Paste everything from line 22 (def log_debug) onward
# Then run normally:
